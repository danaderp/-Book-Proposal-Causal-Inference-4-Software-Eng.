...
\newcommand{\dlse}{DL\textit{4}SE\xspace}
\newcommand{\causalse}{\textit{CausalSoft}\xspace}


\newcommand{\asw}{\textit{Software$_{2.0}$}\xspace}
\newcommand{\sw}{\textit{Software$_{1.0}$}\xspace}
...
% MODELS
\newcommand{\tinymodel}{$Tiny$GPT$_2$ }
\newcommand{\smallmodel}{$Small$GPT$_2$ }
\newcommand{\tinyint}{$TinyGPT_2$(int) }
\newcommand{\ms}{$MS$-GPT$_2$ }
\newcommand{\lstm}{\textit{LSTM} }

\newcommand{\Comet}{{\sc Comet}\xspace}
\newcommand{\Comets}{{\sc Comet's}\xspace}

\newcommand{\techniqueProtsCrits}{$\alpha-$\textit{CodeXplainer} }
\newcommand{\techniqueSEMetrics}{$\beta-$\textit{CodeXplainer} }
\newcommand{\techniqueErrorInfo}{$\gamma-$\textit{CodeXplainer} }
\newcommand{\techniqueInfoTheory}{$\delta-$\textit{CodeXplainer} }
\newcommand{\CodeGenXplainer}{\textit{CodeXplainer} }

\newcommand{\ncg}{NCG\xspace}
\newcommand{\ulm}{ULM\xspace}
%%%%% COMMONS
